...
function RdpClient(config) {
	...
	log.info('Resolution de Hote ' + this.mcs.clientCoreData.obj.desktopWidth.value + 'x' + this.mcs.clientCoreData.obj.desktopHeight.value);
	
	// config keyboard layout
	switch (config.locale) {
	case 'fr':
		log.info('Clavier francais detecter');
		this.mcs.clientCoreData.obj.kbdLayout.value = t125.gcc.KeyboardLayout.FRENCH;
		break;
	case 'en':
	default:
		log.info('Clavier US detecter');
...
RdpClient.prototype.connect = function (host, port) {
	log.info('connecxion au serveur: ' + host + ' sur le port: ' + port);
	var self = this;
